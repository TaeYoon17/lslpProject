...
class Camera: NSObject {
    ...
    private var addToVideoStream: ((AVCaptureVideoDataOutput)->Void)?
    ...
    //MARK: -- 이게 맞나...
    lazy var videoStream: AsyncStream<AVCaptureVideoDataOutput> = {
        AsyncStream { continuation in
            addToVideoStream = { videoOutput in
                continuation.yield(videoOutput)
            }
        }
    }()
